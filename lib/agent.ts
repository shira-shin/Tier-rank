type AgentInput = {
  ...
  metrics: Array<{ name: string; type: "numeric"|"boolean"|"likert"; direction: "MAX"|"MIN"|"TARGET"|"LOG"; weight: number; threshold?: number; params?: any }>;
  use_web_search?: boolean;
};

export async function scoreWithAgent(payload: AgentInput) {
  ...
  try { return JSON.parse(text); } catch (e) { return { error: "PARSE_ERROR", raw: text }; }
}
